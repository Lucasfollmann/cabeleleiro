...
public class Kit {
    ...
    public void Kit() {
        ...
        System.out.println("O tamanho da pizza escolhido foi : " + Cabelo.Size);
        System.out.println("Os sabores Selecionados foram: " + Sobrancelha.listaSobrancelha);
        System.out.println("A borda Selecionada foi: " + listaSobrancelha.valorBarba);
